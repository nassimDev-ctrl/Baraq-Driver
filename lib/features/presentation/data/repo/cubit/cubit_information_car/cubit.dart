import 'dart:io';
import 'package:drever_warr/features/presentation/data/repo/cubit/cubit_information_car/cubit_stat.dart';
import 'package:drever_warr/features/presentation/data/repo/repo/repo_information_car/repo.dart';
...
class CarInfoCubit extends Cubit<CarInfoState> {
  ...
  Future<void> submitCarInfo({
    ...
    result.fold(
      (failure) => emit(CarInfoFailure(failure.errMessage)),
