import 'package:drever_warr/features/my_oreder/presentation/data/cubit/cubit_start_order/cubit_stat.dart';
import 'package:drever_warr/features/my_oreder/presentation/data/cubit/repo/repo_start_tripe/repo.dart';
...
class StartTripCubit extends Cubit<StartTripState> {
  ...
  Future<void> startTrip({required String tripId}) async {
    ...
    result.fold(
      (failure) => emit(StartTripFailure(failure. errMessage)),
