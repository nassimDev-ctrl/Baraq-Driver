...
abstract class DriverStatusRepository {
  Future<Either<Failure, bool>> getDriverAvailability();
  Future<Either<Failure, bool>> setDriverAvailability(bool isAvailable);
}
...
class DriverStatusRepositoryImpl implements DriverStatusRepository {
  ...
  @override
  Future<Either<Failure, bool>> getDriverAvailability() async {
    try {
  ...
  @override
  Future<Either<Failure, bool>> setDriverAvailability(bool isAvailable) async {
    try {
      dev.log(
