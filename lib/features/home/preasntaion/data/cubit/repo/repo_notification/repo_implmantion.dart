...
class NotificationRepositoryImpl implements NotificationRepository {
  ...
  @override
  Future<Either<Failur, NotificationResponseModel>> getNotifications() async {
    try {
  ...
  @override
  Future<Either<Failur, NotificationItemModel>> getNotificationById(String id) async {
    try {
      var response = await apiService.get(
  ...
  @override
  Future<Either<Failur, void>> deleteNotification(String id) async {
    try {
